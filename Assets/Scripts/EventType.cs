public enum EventType
{
	...
	PARRY_HIT,   // Broadcasts when a parry hits an enemy         (data: (StageDirection, double) (direction, inaccuracy in seconds))
	...
	VOLUME_SET   // Broadcasts when the volume is set             (data: float (volume, dB))
};